...
- in the next window (SDL2 location), pick 
  `C:\SDL2-2.0.14\x86_64-w64-mingw32`, then click on `Next>`
...
- from the menu `Project/Build options...` select the `Search
  ...
  `C:\SDL2-2.0.14\x86_64-w64-mingw32\include`, then select `No` when
...
- from the menu `Project/Build options...` select the `Linker
  ...
  `C:\SDL2-2.0.14\x86_64-w64-mingw32\bin\SDL2.dll`, then select
